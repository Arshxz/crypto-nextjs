    ...
    <div className="pt-20 md:pt-32 max-sm:ml-3 lg:w-11/12  mx-auto">
      <div className="flex w-full justify-between md:w-11/12 mx-auto">
        ...
        <div className="pt-10 lg:pt-16 w-full -z-40">
          <div className="text-8xl md:text-6xl font-normal md:font-light tracking-wide w-full md:text-center">
            Satoshi
          </div>
          <div
            key={count}
            className="hero opacity-0 text-sm text-slate-400 w-5/6 md:w-4/6 lg:w-7/12 md:mx-auto h-20 md:text-center"
          >
            {facts[count]}
          </div>
        </div>
        <div className="w-80 max-md:hidden mt-2 text-right relative">
          ...
          <div className="w-60 hidden peer-hover:grid hover:grid text-center absolute right-0">
            <div className="[&>*]:bg-white/40 [&>*]:py-1 [&>*]:rounded-lg bg-black/5 opacity-70 mt-2 grid grid-rows-4 gap-2 border-2 rounded-lg shadow-md p-4">
              ...
              <Link
                href="https://www.linkedin.com/in/arsh99in/"
                target="_blank"
                className="hover:bg-white/60"
              >
                Linkedin
              ...
              <Link
                href="https://twitter.com/Arsh_xy"
                target="_blank"
                className="hover:bg-white/60"
              >
                Twitter
      ...
      {title && (
        <div className="w-full">
          <div className="md:text-center mt-8 md:mt-12 font-semibold md:font-bold text-2xl md:text-4xl uppercase text-slate-700">
            {title}
          </div>
          <div className="md:w-11/12 max-lg:mx-auto text-xs md:text-2xl max-sm:mb-4 md:pt-5 font-semibold md:font-thin">
