  ...
  return (
    <Link href={url} className="group home-action my-8 lg:mx-4">
      <div className="flex items-center text-xl	font-semibold pb-1">
        <div>{title}</div>
        <div className="ml-2 pt-1 group-hover:translate-x-1 motion-safe:transition">
          {arrowRight}
        </div>
      </div>
    ...
    <div className="min-h-screen">
      ...
      <div className="w-3/5 mx-auto md:w-5/12 lg:flex lg:w-4/5 lg:pt-36">
        <Container
          url="explore"
          title="Explore"
          hero="Explore the crypto space"
        />
        <Container
          url="portfolio"
          title="Portfolio"
          hero="Wanna know what projects I am currently invested in?"
        />
        <Container
          url="interests"
          title="Interests"
          hero="Have a quick look at the projects I'm interested in"
        />
        <Container
          url="bonus"
          title="100x"
          hero="Projects I believe could give you a 1000% return"
        />
      </div>
    </div>
  );
